...
In this task we will be practicing Chain-of-Thought Reasoning prompting technique to select a proper Database for Application.
 Theory
AI Technique: Chain-of-Thought Reasoning
...
Result that you got using this prompt(result.txt).
Place your solution files in the appropriate folder of the Challenge project repository on your GitHub account
 
Requirements
Your prompt should use Chain-of-Thought reasoning
The analysis that you got using your prompt should align with all the requirements stated in task description
